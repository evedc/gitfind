...
function App() {
    ...
    const handleGetData = async () => {
        ...
        if (newUser.name) {
            ...
            setCurrentUser({ avatar_url, name, bio, login }); // Ajuste aqui para passar um objeto com os dados

            const reposData = await fetch(`https://api.github.com/users/${user}/repos`);
            const newRepos = await reposData.json(); // Corrige para reposData.json()
